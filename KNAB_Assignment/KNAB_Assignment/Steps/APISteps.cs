...
namespace KNAB_Assignment.Steps
{
    ...
    public sealed class APISteps
    {
        ...
        public RestRequest SetupRequest(string url, Method method)
        {
            ...
            request.AddParameter("key", "9392c2859fde9cf36dca3ffee366817c", ParameterType.QueryString);
            request.AddParameter("token", "0bb1656d72fef1a1fa95b19bcbac55b62f2391d1a45ed37b3ed1e5d63f06c323", ParameterType.QueryString);
